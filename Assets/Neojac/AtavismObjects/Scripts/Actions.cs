...
public class Actions : MonoBehaviour {
	...
	void OnDestroy() {
		EventSystem.UnregisterEvent("ABILITY_UPDATE", this);
		EventSystem.UnregisterEvent("INVENTORY_UPDATE", this);
	}
	...
	void UpdateActions() {
    	...
    	Logger.LogDebugMessage("Got player actions property change: " + actions_prop);
		int pos = 0;
		int bar = 0;
