...
public class StandardCommands : MonoBehaviour {
	...
	public void HandleLoc(string args_str) {
		Logger.LogDebugMessage("Got loc command");
	...
	public void HandleOrient(string args_str) {
		Logger.LogDebugMessage("Got orient command");
	...
	public void HandleSay(string args_str) {
		Logger.LogDebugMessage("Got say command with message: " + args_str);
		...
		Logger.LogDebugMessage("Sent chat message: " + commMessage);
	}
	...
	public void HandleBuildingGridProbe(string args_str) {
		...
		Logger.LogDebugMessage("Created probe");
	}
